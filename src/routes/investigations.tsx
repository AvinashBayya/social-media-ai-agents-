...
const cases = [
  ...
  {
    id: "INV-2035",
    title: "Fintech vendor breach chatter",
    status: "Triage",
    owner: "K. Patel",
    evidence: 24,
    confidence: 61,
  ...
  {
    id: "INV-2029",
    title: "Brand smear · Aster Motors",
    status: "Watch",
    owner: "R. Silva",
    evidence: 17,
    confidence: 42,
...
const evidence = [
  ...
  },
  {
    t: "08:12",
    type: "Video",
    src: "YouTube · GlobalNews",
    note: "Press briefing does not deny surveillance program.",
    tone: "medium" as const,
  },
  {
    t: "07:04",
    type: "Post",
    src: "Reddit · r/netsec",
    note: "Analyst commentary corroborates fintech IOC.",
    tone: "medium" as const,
  },
];
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
                    Suspected exposure of internal surveillance program with imagery attributed to
                    watchlist subject Vector-17. Cross-linked with fintech breach chatter and CIB
                    cluster INV-2038.
                  </p>
                </div>
                  ...
                  <div className="rounded-md border bg-card px-3 py-2 text-center">
                    ...
                    <div className="flex justify-center -space-x-2 pt-1">
                      {["AC", "MO", "KP"].map((a) => (
                        <span
                          key={a}
                          className="grid size-6 place-items-center rounded-full border-2 border-card bg-primary/10 text-[10px] font-semibold text-primary"
                        >
                          {a}
                        </span>
                      ))}
              ...
              <Card>
                ...
                <CardContent className="space-y-2 text-sm">
                  <div className="rounded-md border border-primary/20 bg-primary/5 p-2.5 text-xs">
                    Cross-corroboration across 3 independent sources raises confidence to 78%.
                    Recommend escalation and legal review before external disclosure.
                  </div>
                ...
                {[
                  {
                    u: "M. Ortega",
                    t: "08:14",
                    m: "EXIF metadata authentic. Suggest chain-of-custody review.",
                  },
                  {
                    u: "A. Chen",
                    t: "09:02",
                    m: "Cross-linking with INV-2038 disinfo cluster. Confidence ↑ 12 pts.",
                  },
                ].map((c, i) => (
