...
import { geminiGenerateReport } from "@/utils/gemini";
...
function ExportsPage() {
  ...
  const handleExport = async (format: string) => {
    ...
    try {
      ...
      // 2. Generate real-time Gemini AI report summary
      const aiReport = await geminiGenerateReport({
        data: {
  ...
  return (
    <AppShell>
      <PageHeader
        ...
        description="Fetch live intelligence telemetry, run Gemini AI analysis, and export ready-to-file PDF, HTML, JSON, CSV, or Markdown reports."
      />
